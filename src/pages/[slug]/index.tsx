...
import { allSlugsLookup } from "../../components/transformation/contentful/trSlugs";
import { transformTemplate } from "../../components/transformation/contentful/trTemplates";
// import { transformPostCategory } from "../../components/transformation/contentful/trPostCategory";
import Entries from "../../components/presentation/entries/prEntries";
import { ISlug } from "../../types/cf-types";
import {
  transformHtmlHeadProperties,
  // transformHtmlHeadScripts,
  // transformHtmlHeadStylesheet,
} from "../../components/transformation/contentful/trHtmlHead";
import { transformPage } from "../../components/transformation/contentful/trPage";
...
function DynamicSlugPage({
  ...
  const pageContents = ThisPageDetails.pageContents;
...
export const getStaticProps: GetStaticProps = async (context) => {
  ...
  // =====================================
  const thisPageDetails = await transformPage(slug);
  ...
  //  - Main Navigation
  //  - Footer
  const templateID = thisPageDetails.pageTemplateID;
  ...
  // const globalScripts = await transformHtmlHeadScripts();
  // const globalStylesheet = await transformHtmlHeadStylesheet();
...
export const getStaticPaths: GetStaticPaths = async () => {
  // !=======================================================
  // const objSlugs: ISlug[] = await fetchCFData("slug", 100, 1, "", "*", "");
